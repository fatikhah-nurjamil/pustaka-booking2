    ...
    <div class="row">
        <div class="col-lg-3">
            <?php if(validation_errors()){?>
                ...
                data-toggle="modal" data-target="#kategoriBaruModal">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <i class="fas fa-edit"></i> Ubah</a></td> <td>
                                <a href="<?=base_url('buku/hapusKategori/').$k['id'];?>" onclick="return confirm
                                ('Kamu yakin akan menghapus <?= $judul.' '.$k['kategori'];?>?');" 
